...
const en: Dict = {
  ...
  "playtest.exit": "Esc to exit · arrows to steer",
  "playtest.pellets": "pellets left",
  "playtest.eaten": "You were caught! Esc to exit, R to restart",
  "playtest.cleared": "Level cleared! Esc to exit, R to restart",
  ...
  "tour.canvas.body": "Drag to draw, mouse wheel to zoom, hold Space or use Pan to move around. The canvas is keyboard-accessible too: focus it, move with arrows, place with Enter.",
  ...
  "tour.play.body": "Runs the real game engine on your level right here. Arrows steer, R restarts, Esc exits.",
...
const ru: Dict = {
  ...
  "playtest.exit": "Esc — выход · стрелки — управление",
  ...
  "tour.canvas.body": "Тяните, чтобы рисовать; колесо — зум; зажмите пробел или возьмите «Руку», чтобы двигаться. Работает и с клавиатуры: фокус на холст, стрелки — курсор, Enter — поставить блок.",
  ...
  "tour.play.body": "Запускает настоящий игровой движок на вашем уровне прямо здесь. Стрелки — управление, R — заново, Esc — выход.",
...
const ja: Dict = {
  ...
  "playtest.exit": "Esc で終了 · 矢印キーで操作",
  "playtest.pellets": "残りドット",
  "playtest.eaten": "捕まりました！Esc で終了、R で再開",
  "playtest.cleared": "クリア！Esc で終了、R で再開",

  "error.load": "レベルの読み込みに失敗しました",
  "tour.tools.title": "ツール",
  "tour.tools.body": "ペイント、消しゴム、直線、枠、塗りつぶし、移動。1〜6キーで切り替え。",
  ...
  "tour.canvas.body": "ドラッグで描画、ホイールでズーム、スペース長押しか移動ツールで画面移動。キーボードでも操作可能：フォーカスして矢印で移動、Enter で配置。",
  ...
  "tour.play.body": "本物のゲームエンジンでこのレベルをその場で実行。矢印キーで操作、R で再開、Esc で終了。",
